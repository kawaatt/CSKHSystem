...
namespace TELEBOT_CSKH.Services
{
    public interface IBaseServices
    {
        ...
        Task<ResponseDTO?> LiveSendAsync(RequestDTO requestDTO);
    ...
    public class BaseServices : IBaseServices
    {
        ...
        public async Task<ResponseDTO?> LiveSendAsync(RequestDTO requestDTO)
        {
            try
            {
                HttpClient client = _httpclientFactory.CreateClient();
                ...
                switch (apiResponse.StatusCode)
                {
                    ...
                    default:
                        apiResponse.EnsureSuccessStatusCode();
                        var apiContent = await apiResponse.Content.ReadAsStringAsync();
                        //Console.WriteLine("RESPONSE  =>>  " + apiContent);
                        return new ResponseDTO { Result = JsonConvert.DeserializeObject<dynamic>(apiContent) };
                }
            }
            catch (Exception ex)
            {
