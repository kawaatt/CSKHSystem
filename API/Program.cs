...
using API.Constant;
using API.Data;
using API.Middleware.TicketRequestMW;
using API.Services;
...
static void BuildOidc(WebApplicationBuilder builder)
{
    ...
    builder.Services
        ...
        .AddJwtBearer("Bearer", options =>
        {
            ...
            var validAudiences = new[] { "livestream", "api1" };
...
static void BuildOtherServive(WebApplicationBuilder builder)
{
    ...
    builder.Services.AddScoped<IImageUploadService, ImageUploadService>(); // Thêm đối tượng ImageUploadService vào dịch vụ>
    //builder.Services.AddHostedService<RBMCSKHAutoConsumer>();
}
